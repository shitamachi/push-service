...
func (tx *Tx) init() {
	tx.UserPlatformTokens = NewUserPlatformTokensClient(tx.config)
	tx.UserPushToken = NewUserPushTokenClient(tx.config)
}
...
// applies a query, for example: UserPlatformTokens.QueryXXX(), the query will be executed
