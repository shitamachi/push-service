...
func ID(id int) predicate.UserPushToken {
	return predicate.UserPushToken(func(s *sql.Selector) {
...
func Token(v string) predicate.UserPushToken {
	return predicate.UserPushToken(func(s *sql.Selector) {
...
func AppID(v string) predicate.UserPushToken {
	return predicate.UserPushToken(func(s *sql.Selector) {
...
func And(predicates ...predicate.UserPushToken) predicate.UserPushToken {
	return predicate.UserPushToken(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.UserPushToken) predicate.UserPushToken {
	return predicate.UserPushToken(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.UserPushToken) predicate.UserPushToken {
	return predicate.UserPushToken(func(s *sql.Selector) {
		p(s.Not())
	})
}
